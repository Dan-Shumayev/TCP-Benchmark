...
int main(int argc, char *argv[])
{
    ...
    printf("Connection successful! Starting.../n");

    // TODO - understand these two calls
    fcntl(sockfd, F_SETFL, O_NONBLOCK); // Turn on the Non-Blocking bit of the socket file descriptors's flags
    int flag = 1;
    ...
    {
        // Cycles to be replaced by time or to be converted manually
